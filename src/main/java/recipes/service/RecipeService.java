...
public class RecipeService {
	...
	private List<String> convertContentToSqlStatements(String content) {
		...
		content = replaceWhtespaceSequenceWithSingleSpace(content);
	...
	private String replaceWhtespaceSequenceWithSingleSpace(String content) {
		// \\s+ is white space - regilar expression cheet sheet
